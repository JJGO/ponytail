...
const INVARIANTS = [
  'How this repo already works',           // local code beats generic advice
  'happy to debug at 3am',                 // optimize for maintainability, not LOC
  ...
  'security',
  'accessibility',
  "Follow the repo's test style and depth",
  'Deleted feature = deleted tests',
  'Throwaway tests',
];
