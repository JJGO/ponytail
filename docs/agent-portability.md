...
| pi | `pi-extension/`, `skills/`, `hooks/` | Package extension: injects the ruleset each turn and registers the `/ponytail` commands; skills remain user-invokable but are hidden from model invocation. |
