...
- It does this **without dropping a tested safety guard** (20/20 checks), while the bare
  "one-liner" prompt was the only arm that did (19/20), and was also inconsistent on size. This
  sample is a floor, not a security proof.
